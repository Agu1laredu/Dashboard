...
import Foto from "./assets/b5ed810a-4e20-46a5-a278-50ece165bde9.jpg";
import {
  RiHome6Line,
  RiShieldUserLine,
  RiCalendar2Line,
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        >
          <img
            className="text-2xl uppercase font-bold mb-10"
            src={Foto}
            alt=""
            style={{
              width: "150px",
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <h5 className="font-medium">Aguilar J.Eduardo</h5>
      ...
      <header className="fixed bg-gray-100 w-full xl:w-[calc(100%-384px)] xl:ml-96 flex flex-col md:flex-row items-center justify-between gap-4 p-4">
        ...
        <nav className="flex items-center gap-2 text-lg">
          <Menu as="div">
            <Menu.Button className="hover:bg-gray-200 p-2 rounded-lg transition-colors relative"></Menu.Button>
            <Transition
                ...
                <div>
                  ...
                  <Menu.Item>
                    ...
                    >
                      ...
                      />
                      <div>
                        <h5 className="text-base">Aguilar J.Eduardo</h5>
